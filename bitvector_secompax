...
/*void ibis::bitvector::compress_secompax() {
	...
	void decode() {
		...
		isDirty0 =( (int)(bool)(*it & SECOMPAX_0_DIRTYMASK1)+(int)(bool)(*it & SECOMPAX_0_DIRTYMASK2)+(int)(bool)(*it & SECOMPAX_0_DIRTYMASK3)+(int)(bool)(*it & SECOMPAX_1_DIRTYMASK4) == 1 );
		...
		dirtyPos0 = ((int)(bool)(*it & SECOMPAX_1_DIRTYMASK4) << 3 )+ ((int)(bool)(*it & SECOMPAX_0_DIRTYMASK3) << 2) + ((int)(bool)(*it & SECOMPAX_0_DIRTYMASK2) << 1 ) + ((int)(bool)(*it & SECOMPAX_0_DIRTYMASK1));   // More efficient
	...
	{	
		...
		isDirty0 =( (int)(bool)((tmp) & SECOMPAX_0_DIRTYMASK1)+(int)(bool)((tmp) & SECOMPAX_0_DIRTYMASK2)+(int)(bool)((tmp) & SECOMPAX_0_DIRTYMASK3)+(int)(bool)((tmp) & SECOMPAX_1_DIRTYMASK4) == 1 );
		//isDirty1 =( (int)(bool)(*it & SECOMPAX_1_DIRTYMASK1)+(int)(bool)(*it & SECOMPAX_1_DIRTYMASK2)+(int)(bool)(*it & SECOMPAX_1_DIRTYMASK3)+(int)(bool)(*it & SECOMPAX_1_DIRTYMASK4) == 1 );
		...
		dirtyPos0 = ((int)(bool)(tmp & SECOMPAX_1_DIRTYMASK4) << 3 )+ ((int)(bool)(tmp & SECOMPAX_0_DIRTYMASK3) << 2) + ((int)(bool)(tmp & SECOMPAX_0_DIRTYMASK2) << 1 ) + ((int)(bool)(tmp & SECOMPAX_0_DIRTYMASK1));   // More efficient
		//dirtyPos1 = ((int)(bool)(*it & SECOMPAX_1_DIRTYMASK4) << 3 )+ ((int)(bool)(*it & SECOMPAX_1_DIRTYMASK3) << 2) + ((int)(bool)(*it & SECOMPAX_1_DIRTYMASK2) << 1 ) + ((int)(bool)(*it & SECOMPAX_1_DIRTYMASK1));   // More efficient
...
*/	
	...
	if (last.isFill) { // last word was a fill word
	    if (current.isFill) { // current word is a fill word
		if (current.fillBit == last.fillBit) { // same type of fill
			if(last.nWords + current.nWords <= MAXCNT)
		    *(last.it) += current.nWords;
			/*else
			{
				*(beforeLast.it) = *(last.it);
...
void ibis::bitvector::decompress_secompax(int begin, int end)
{
	struct xrun {
		bool isLiteral;
		int secpxType;
